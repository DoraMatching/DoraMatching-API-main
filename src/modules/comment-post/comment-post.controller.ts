...
export class CommentPostController {
    ...
    @Auth()
    @ApiOperation({ summary: 'Create post-comment by :postId and :commentId', description: 'Create a comment with postId' })
    ...
    @Auth()
    @ApiOperation({ summary: 'Update post-comment by :postId and :commentId', description: 'Update post comment' })
    ...
    @Auth()
    @ApiOperation({ summary: 'Delete post-comment by :postId and :commentId', description: 'Return delete status' })
