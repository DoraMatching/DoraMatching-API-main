...
export class CommentQuestionController {
    ...
    @Auth()
    @ApiOperation({ summary: 'Create question comment by :questionId', description: 'Create a comment with questionId' })
    ...
    @Auth()
    @ApiOperation({ summary: 'Update question comment by :questionId and :commentId', description: 'Update post comment' })
    ...
    @Auth()
    @ApiOperation({ summary: 'Delete question comment by :questionId and :commentId', description: 'Return delete status' })
