...
import { CommentQuestionParam, CreateCommentQuestionDTO, UpdateCommentQuestionDTO } from '@comment-question/dto';
...
export class CommentQuestionController {
    ...
    createComment(@Param() { id }: FindOneParams, @Body() data: CreateCommentQuestionDTO, @User() jwtUser: JwtUser) {
    ...
    updateCommentById(@Param() params: CommentQuestionParam, @Body() data: UpdateCommentQuestionDTO, @User() jwtUser: JwtUser) {
    ...
    deleteCommentById(@Param() params: CommentQuestionParam, @User() jwtUser: JwtUser) {
